...
export class TableComponent implements OnInit {
  ...
  ngOnInit() { 
    ...
    this.table = new Table(0, 4, 13, 'available');
  ...
  addTable(){
    $("#table-number").val(this.table.tableNumber);
    $("#table-seats").val(this.table.capacity);
    $(".table-details").html(this.table.tableNumber);
